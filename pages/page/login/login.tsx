...
const Login = () => {
  ...
  return (
    <>
      <div className="bg-white p-9 mt-14 rounded-l ml-3 mr-3">
        <div className=" rounded-sm  bg-white shadow-default dark:border-strokedark dark:bg-boxdark h-[100%]">
          <div className="flex flex-wrap items-center h-[100%]">
            <div className="hidden w-full xl:block xl:w-1/2 h-[100%]">
              <div className="py-27.5 px-26 text-center">
                <Link className="mb-5.5 flex justify-center" href="/">
                  <img
                    src={"/logo-icon.svg"}
                    alt="Logo"
                    width={32}
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                        className="w-full rounded-lg border border-stroke bg-transparent text-black py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                      />
                  ...
                  <div className="mb-6">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full  text-black rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                      />
                  ...
                  <div className="mb-5">
                    ...
                    <button
                      type="submit"
                      value="Sign In"
                      className="w-full z-10 cursor-pointer rounded-lg border border-primary bg-blue-600 p-4 text-white transition hover:bg-opacity-90"
                    >
                      Sign In
                    </button>
                    {/* </Link> */}
