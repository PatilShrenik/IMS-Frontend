...
import EditRoleDrawer from "../SideDrawers/EditRoleDrawer";
import { deleteRoleById } from "@/pages/api/api/RoleManagementAPI";
...
const RoleMenu = (props: any) => {
    ...
    const handleDeleteClick = async (rowId: number) => {
      ...
      try {
        const response = await deleteRoleById(rowId);
