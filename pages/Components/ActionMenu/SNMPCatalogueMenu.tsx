...
import EditSNMPCatalogueDrawer from "../SideDrawers/EditSNMPCatalogueDrawer";
import { deleteSNMPCatalog } from "@/pages/api/api/SNMPCatalogueAPI";

const SNMPCatalogueMenu = (props: any) => {
    ...
    const { toggleDeviceTableState, toggleGetSNMPCatApiState  } = useAppContext();
...
export default SNMPCatalogueMenu;
