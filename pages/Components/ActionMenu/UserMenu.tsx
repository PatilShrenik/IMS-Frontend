...
import EditUserDrawer from "../SideDrawers/EditUserDrawer";
import { deleteUser } from "@/pages/api/api/UserManagementAPI";
...
const UserMenu = (props: any) => {
    ...
    const { toggleDeviceTableState, toggleGetUserApiState } = useAppContext();
